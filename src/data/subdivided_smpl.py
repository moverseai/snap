...
class SubdividedSMPL(torch.utils.data.Dataset):
    def __init__(
        ...
        self.areas = np.sqrt(vareas.numpy().copy() / np.pi) / 3.5
        ...
        )  # TODO: resolution is currently hardcoded
    ...
    def __getitem__(self, index) -> typing.Any:
        ...
        return {
            ...
            "faces": self.faces,
            "extrinsics": self.extrinsics[self.subset], 
            "intrinsics": self.intrinsics[self.subset], 
            "betas": self.betas,
